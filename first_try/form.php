...
setcookie('cookieAnt', 'M@teo21', $expiry->getTimestamp(), null, null, false, true);
...
<html lang="fr">
  ...
  <head>
    ...
    <title>Alpha Projects - Accueil - Créez ou collaborez à un projet.</title>
...
<div class="container well">
  <div class="row content">
    <div class=" container-fluid col-sm-12 text-center">
      ...
      <p class="col-sm-10 col-sm-offset-1"><img class="img" alt="photo du projet" src="./img/GIF-APACHE-LOADER-50px.gif" data-holder-rendered="true" style="width: 45px; height: auto;"></p>
    </div>  
 </div>
</div>
